!function (n) {
    ...
    n.fn.priceFormat = function (t) {
        ...
        return n(window).bind("keyup keydown", function (n) {
            return window.ctrl_down = n.ctrlKey,
                !0
        }),
            ...
            this.each(function () {
                function r(n) {
                    h.is("input") ? h.val(n) : h.html(n),
                        h.trigger("pricechange")
                }
                function e() {
                ...
                function u(t, i) {
                    ...
                    return !F || 0 == s && 0 == c || (r = t.indexOf("-") != -1 && t.indexOf("+") < t.indexOf("-") ? "-" + r : O ? "+" + r : "" + r),
                        g && (r = g + r),
                        w && (r += w),
                        r
                }
                ...
                O && (F = !0),
                    ...
                    S && (h.bind("focusout.price_format", function () {
                        d()
                    }),
        ...
        n.fn.priceToFloat = function () {
            return n(this).is("input") ? field = n(this).val() || [] : field = n(this).html(),
                parseFloat(field.replace(/[^0-9\-\.]/g, ""))
        }
        ,
